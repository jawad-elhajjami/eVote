...
export default function SignupPage() {
  ...
  const getPasswordStrength = (
    ...
    if (strength <= 2)
      return { strength, label: "Weak", color: "text-red-400" };
    if (strength <= 4)
      return { strength, label: "Medium", color: "text-yellow-400" };
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-purple-900/30 border border-purple-500/30 rounded-lg p-3 flex items-start space-x-3">
                ...
                <p className="text-sm text-gray-300">
                  Your account will be secured with cryptographic keys. All data
